...
<i class="fas fa-building"></i>FORM UPDATE USERS
</div>
...
<form method="post" action="<?php echo base_url('administrator/user/update_aksi')?>">
    <div class="form-group">
        ...
        <input type="hidden" name="id" placeholder="masukkan Username" class="form-control"
 ...
 <div class="form-group">
    ...
    <div class="form-group">
       ...
       <?php 
        ...
        <option value="walmur">Walmur</option>
        ...
        <option value="walmur" selected>Walmur</option>
        <option value="pemilik " >Pemilik</option>
        <option value="tutor">Tutor</option>
