...
<i class="fas fa-plus"></i>FORM TAMBAH DATA KRPP
</div>

<form method="post" action="<?php echo base_url('administrator/krpp/tambah_krpp_aksi')?>">
    ...
    <div class="form-group">
        ...
        <input type="text" name="thn_ajaran_smt" class="form-control"  value="<?php echo $thn_ajaran_smt ?>" readonly/>
    </div>
