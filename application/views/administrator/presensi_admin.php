...
<div class="d-flex justify-content-between mb-3">
 ...
 <a class="btn btn-sm btn-warning mb-2" href="<?php echo base_url('administrator/presensi_admin/form_cetak_presensi')?>"> 
   ...
   <Table class="table table-stripped table-warning table-hover table-bordered"  >
      ...
      <?php
        ...
        <tr>
            ...
            <td width="20px"><?php echo anchor('administrator/presensi_admin/delete/'.$prs['id'],
