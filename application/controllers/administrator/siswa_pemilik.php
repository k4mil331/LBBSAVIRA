...
class Siswa_pemilik extends CI_Controller {
    ...
    public function index()
    {
        ...
        $config['base_url'] ='http://localhost/tugasakhirfiks/administrator/siswa_pemilik/index';
    ...
    public function detail($id)
    {
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar_pemilik');
        $this->load->view('administrator/siswa_pemilik_detail',$data);
        $this->load->view('template_administrator/footer');
    }
    ...
    public function delete($id) {
        ...
        redirect('administrator/siswa_pemilik');
}
