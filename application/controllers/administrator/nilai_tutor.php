...
class Nilai_tutor extends CI_Controller{
    public function index()
    {
        ...
        $this->load->view('administrator/masuk_lhb_tutor',$data);
    ...
    
    {
        ...
        redirect('administrator/nilai_tutor');
        }
        ...
        $data = array (
         ...
         $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar_tutor');
        $this->load->view('administrator/lhb_tutor',$data);
        $this->load->view('template_administrator/footer');
    }
} 
...
{
    $data['matapelajaran'] = $this->matapelajaran_model->get_matapelajaran();
    $data += array( 
    ...
    $this->load->view('template_administrator/header');
    $this->load->view('template_administrator/sidebar_tutor');
    $this->load->view('administrator/input_nilai_form_tutor', $data);
    $this->load->view('template_administrator/footer');
}
    ...
    public function input_nilai_aksi()
    {
        ...
        if($this->form_validation->run() == FALSE ) {
            ...
            $data = array (
             ...
             $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar_tutor');
        $this->load->view('administrator/form_nilai_tutor',$data);
        $this->load->view('template_administrator/footer');
        }
    }
